...
fun floatFromBits(bits: Int): Float = java.lang.Float.intBitsToFloat(bits)

/** Returns the [Double] value corresponding to a given bit representation. */
fun doubleFromBits(bits: Long): Double = java.lang.Double.longBitsToDouble(bits)
 ...
 */
fun Float.fastRoundToInt(): Int = Math.round(this)
 ...
 * - +Infinity or any value greater than Integer.MAX_VALUE becomes Integer.MAX_VALUE.toFloat()
 */
fun Double.fastRoundToInt(): Int = Math.round(this).toInt()
